...
public class HashMapExample {
    public static void main(String[] args) {
        ...
        System.out.println("Accessing items from HashMap");
        ...
        System.out.println("Removing an item from HashMap");
        map.remove("India");
        System.out.println("Item removed");
        System.out.println("HashMap after removing India:" + map);

        System.out.println();

        //Loop through the HashMap to access Keys and Value both
        ...
        //Checking if HashMap contains a particular key, value or not
